<template>
	<view>
		<wait-pay :endorse.sync='endorse' :orderData.sync='orderData' :waitText.sync='waitText' :godate.sync='godate' :dateweek.sync='dateweek'></wait-pay>
	</view>
</template>
...
<script>
	...
	export default {
		...
		onLoad: function(e) {
			...
			this.orderData=require('../../static/json/endorseData2.json')
			// uni.request({
